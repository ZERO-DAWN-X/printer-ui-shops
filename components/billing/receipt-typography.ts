...
export const receiptQtyMetaClass = "text-center text-[11px] font-bold leading-[1.38] text-black/85";
export const receiptThankYouBlockClass = "mt-2 text-center text-[12px] font-bold leading-snug";
export const receiptSystemCreditClass = "mt-2 text-center text-[10px] font-bold leading-[1.38] text-black";

/** TOTAL banner / emphasized row — keep in sync with print CSS `#print-root .total-highlight`. */
export const receiptTotalEmphasisClass = "text-[18px]";
