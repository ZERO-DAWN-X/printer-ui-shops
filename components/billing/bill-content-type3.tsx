  ...
  return (
    <div className="receipt-content font-mono text-[12px] leading-snug text-black">
      <div className="receipt-section text-center">
        <p className="mb-1 border-b border-black pb-0.5 text-[10px] font-bold uppercase tracking-[0.2em]">
          Sales receipt
        </p>
        <h1 className="font-sans text-[24px] font-extrabold leading-[1.12] tracking-tight">{shopDetails.name}</h1>
        <p className="mt-1 font-sans text-[11px]">{shopDetails.address}</p>
        <p className="text-[11px]">Tel: {shopDetails.phone}</p>
      </div>

      <Dashed />

      <div className="receipt-section text-[11px]">
      ...
      <div className="receipt-section mb-1 flex text-[11px] font-bold uppercase tracking-wide">
      ...
      <div className="min-h-[40px]">
        {items.length === 0 ? (
          ...
          items.map((item) => {
            ...
            return (
              <div key={item.id} className="receipt-item mb-1 flex items-end gap-1 text-[12px]">
                <span className="flex-1 font-sans text-[13px] font-semibold wrap-break-word leading-tight">
                  {primary}{" "}
                  {englishParen ? (
                    <span className="text-[11px] font-medium text-black/60">{englishParen}</span>
                  ) : null}
                  {englishParen ? " " : null}
      ...
      <div className="text-[12px]">
        ...
        <div className="my-1 flex justify-between text-[15px] font-extrabold text-black">
      ...
      <div className="mt-2 text-center font-sans text-[12px] font-bold">
